...
type MovieDetails struct {
	...
	Mtadata       *Metadata              `protobuf:"bytes,2,opt,name=mtadata,proto3" json:"mtadata,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MovieDetails) GetMtadata() *Metadata {
	if x != nil {
		return x.Mtadata
	}
	return nil
...
type GetMovieDetailsRespoonse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetMovieDetailsRespoonse) Reset() {
	*x = GetMovieDetailsRespoonse{}
	mi := &file_movie_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetMovieDetailsRespoonse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetMovieDetailsRespoonse) ProtoMessage() {}

func (x *GetMovieDetailsRespoonse) ProtoReflect() protoreflect.Message {
	mi := &file_movie_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetMovieDetailsRespoonse.ProtoReflect.Descriptor instead.
func (*GetMovieDetailsRespoonse) Descriptor() ([]byte, []int) {
	return file_movie_proto_rawDescGZIP(), []int{9}
}

func (x *GetMovieDetailsRespoonse) GetMovieDetails() *MovieDetails {
	if x != nil {
...
const file_movie_proto_rawDesc = "" +
	...
	"\bdirector\x18\x04 \x01(\tR\bdirector\"K\n" +
	"\fMovieDetails\x12\x16\n" +
	"\x06rating\x18\x01 \x01(\x01R\x06rating\x12#\n" +
	"\amtadata\x18\x02 \x01(\v2\t.MetadataR\amtadata\"/\n" +
	...
	"\bmovie_id\x18\x01 \x01(\tR\amovieId\"N\n" +
	"\x18GetMovieDetailsRespoonse\x122\n" +
	...
	"\tPutRating\x12\x11.PutRatingRequest\x1a\x12.PutRatingResponse2U\n" +
	"\fMovieService\x12E\n" +
	"\x0fGetMovieDetails\x12\x17.GetMovieDetailsRequest\x1a\x19.GetMovieDetailsRespoonseB\x06Z\x04/genb\x06proto3"
...
var file_movie_proto_goTypes = []any{
	...
	(*GetMovieDetailsRespoonse)(nil),    // 9: GetMovieDetailsRespoonse
}
var file_movie_proto_depIdxs = []int32{
	0, // 0: MovieDetails.mtadata:type_name -> Metadata
	0, // 1: GetMetadataResponse.metadata:type_name -> Metadata
	1, // 2: GetMovieDetailsRespoonse.movie_details:type_name -> MovieDetails
	...
	9, // 10: MovieService.GetMovieDetails:output_type -> GetMovieDetailsRespoonse
