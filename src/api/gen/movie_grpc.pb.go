...
type MovieServiceClient interface {
	GetMovieDetails(ctx context.Context, in *GetMovieDetailsRequest, opts ...grpc.CallOption) (*GetMovieDetailsRespoonse, error)
}
...
func (c *movieServiceClient) GetMovieDetails(ctx context.Context, in *GetMovieDetailsRequest, opts ...grpc.CallOption) (*GetMovieDetailsRespoonse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetMovieDetailsRespoonse)
...
type MovieServiceServer interface {
	GetMovieDetails(context.Context, *GetMovieDetailsRequest) (*GetMovieDetailsRespoonse, error)
...
func (UnimplementedMovieServiceServer) GetMovieDetails(context.Context, *GetMovieDetailsRequest) (*GetMovieDetailsRespoonse, error) {
